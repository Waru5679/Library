...
void CTitleObj::Draw()
{
	...
	////文字列に変換する
	//_itow_s((int)m_ScreenPos.x, m_wPos_x, sizeof(m_wPos_x), 10);
	//FONT->DrawStr(m_wPos_x, 0.0f, 0.0f, 32.0f, 0.0f);

	//_itow_s((int)m_ScreenPos.y, m_wPos_y,sizeof(m_wPos_y), 10);
	//FONT->DrawStr(m_wPos_y, 0.0f, 32.0f, 32.0f, 0.0f);
